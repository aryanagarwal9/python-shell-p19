...
class Tail(Application):
    ...
    def handle_only_file_input(self, args: list, out: deque):
    ...
    def handle_num_of_lines_and_stdin(self, args: list, stdin: Optional[list], out: deque):
    ...
    def handle_num_of_lines_and_file(self, args: list, out: deque):
    ...
    def get_lines(self, num_lines: int = 10, file: str = None, stdin: str = None, src: str = 'file') -> list:
        res = []
