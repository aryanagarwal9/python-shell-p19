...
class TestHead(unittest.TestCase):
    ...
    @parameterized.expand([
        ...
        ['multiple_single_bytes', ['-b', '0,2', 'resources/test1.txt'],
         ['02\n', '46\n']],
        ['out_of_range_bytes', ['-b', '0,2,8', 'resources/test1.txt'],
         ['02\n', '46\n']],
        ['single_byte_range', ['-b', '0-3', 'resources/test1.txt'],
         ['0123\n', '4567\n']],
        ['multiple_byte_ranges', ['-b', '0-1,2-3', 'resources/test1.txt'],
         ['0123\n', '4567\n']],
        ['out_of_range_byte_range', ['-b', '0-9', 'resources/test1.txt'],
         ['0123\n', '4567\n']],
        ['unsorted_single_bytes', ['-b', '3,1,2', 'resources/test1.txt'],
         ['123\n', '567\n']],
        ['unsorted_byte_ranges', ['-b', '2-3,1-2', 'resources/test1.txt'],
         ['123\n', '567\n']],
        ['reversed_byte_ranges', ['-b', '3-1', 'resources/test1.txt'],
         ['\n', '\n']],
        ['bytes_and_ranges', ['-b', '0,2-3', 'resources/test1.txt'],
         ['023\n', '467\n']]
    ])
    ...
    def test_cut_without_stdin(self):
        app = Cut()
        self.assertRaises(StandardInputError, app.exec, args=['-b', '0'],
