...
class TestUniq(unittest.TestCase):
    ...
    @parameterized.expand([
        ['duplicate_adjacent_lines_available', ['resources/test_uniq1.txt'], ['java\n', 'python\n', 'Python\n', 'c++\n', 'c\n', 'haskell\n', 'ruby\n', 'Ocaml\n', 'ocaml\n',
                          'haskell']],
        ['no_duplicate_adjacent_lines', ['resources/test_uniq2.txt'], ['java\n', 'python\n', 'c++\n', 'c\n', 'haskell\n', 'ruby\n', 'Ocaml\n', 'haskell\n']]
    ])
    ...
    @parameterized.expand([
        ['duplicate_adjacent_lines_available', ['-i', 'resources/test_uniq1.txt'], ['java\n', 'python\n', 'c++\n', 'c\n', 'haskell\n', 'ruby\n', 'Ocaml\n',
                          'haskell']],
        ['no_duplicate_adjacent_lines', ['-i', 'resources/test_uniq2.txt'], ['java\n', 'python\n', 'c++\n', 'c\n', 'haskell\n', 'ruby\n', 'Ocaml\n', 'haskell\n']]
    ])
    ...
    def test_uniq_flag_given_but_no_stdin(self):
        app = Uniq()
        self.assertRaises(ValueError, app.exec, args=['-i'],stdin=None, out=self.out)

    def test_uniq_wrong_number_of_arguments(self):
        app = Uniq()
        self.assertRaises(ValueError, app.exec, args=['-i', 'test_uniq1.txt', 'test_uniq2.txt'],stdin=None, out=self.out)

    def test_uniq_flag_at_incorrect_index(self):
        app = Uniq()
        self.assertRaises(FlagError, app.exec, args=[os.path.join(self.directory, 'test_uniq1.txt'), '-i'],stdin=None, out=self.out)
